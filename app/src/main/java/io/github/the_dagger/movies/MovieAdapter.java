...
public class MovieAdapter extends ArrayAdapter<SingleMovie> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(getContext()).load(singleMovie.movieImage).error(R.drawable.placeholder).into(poster, PicassoPalette.with(singleMovie.movieImage, poster).use(PicassoPalette.Profile.MUTED)
                .intoBackground(name));
